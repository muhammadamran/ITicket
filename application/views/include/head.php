...
<head>
	<meta charset="utf-8" />
	<title><?php echo $this->session->userdata('nama_perusahaan'); ?></title>
	<link rel="icon" type="image/png" href="<?php echo base_url().'assets/img/logo/'.$this->session->userdata('icon'); ?>">
